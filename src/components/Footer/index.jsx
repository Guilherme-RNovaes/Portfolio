  ...
  return (
    <footer className="contato" id='contato'>
        ...
        <div className="contato-social">
            ...
            <a href="https://www.linkedin.com/in/guilherme-r-novaes/" target="_blank" rel="noreferrer"><AiOutlineLinkedin size={30} /></a>
            <a href="https://api.whatsapp.com/send?phone=5516988448896&text=Ol%C3%A1,%20Guilherme!" target="_blank" rel="noreferrer"><AiOutlineWhatsApp size={30} /></a>
