...
const userProps: User =
{
  ...
  aboutContact: 'Vamos conversar? Entre em contato e vamos transformar suas ideias em realidade. Estou à disposição para criar soluções digitais sob medida para você ou sua empresa!',
